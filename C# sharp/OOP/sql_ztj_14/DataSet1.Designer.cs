...
namespace sql_ztj_14 {
    ...
    public partial class DataSet1 : global::System.Data.DataSet {
        ...
        public partial class UsersDataTable : global::System.Data.TypedTableBase<UsersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public UsersRow AddUsersRow(int Id, string Name, int Age, string Gender, string City) {
...
namespace sql_ztj_14.DataSet1TableAdapters {
    ...
    public partial class UsersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Users] WHERE (([Id] = @Original_Id) AND ([Name] = @Original_Na" +
                "me) AND ([Age] = @Original_Age) AND ([Gender] = @Original_Gender) AND ([City] = " +
                "@Original_City))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Users] ([Id], [Name], [Age], [Gender], [City]) VALUES (@Id, @N" +
                "ame, @Age, @Gender, @City);\r\nSELECT Id, Name, Age, Gender, City FROM Users WHERE" +
                " (Id = @Id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Users] SET [Id] = @Id, [Name] = @Name, [Age] = @Age, [Gender] = @Gender, [City] = @City WHERE (([Id] = @Original_Id) AND ([Name] = @Original_Name) AND ([Age] = @Original_Age) AND ([Gender] = @Original_Gender) AND ([City] = @Original_City));
SELECT Id, Name, Age, Gender, City FROM Users WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::sql_ztj_14.Properties.Settings.Default.NewBaseConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Name, Age, Gender, City FROM dbo.Users";
        ...
        public virtual int Delete(int Original_Id, string Original_Name, int Original_Age, string Original_Gender, string Original_City) {
        ...
        public virtual int Insert(int Id, string Name, int Age, string Gender, string City) {
        ...
        public virtual int Update(int Id, string Name, int Age, string Gender, string City, int Original_Id, string Original_Name, int Original_Age, string Original_Gender, string Original_City) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, int Age, string Gender, string City, int Original_Id, string Original_Name, int Original_Age, string Original_Gender, string Original_City) {
            return this.Update(Original_Id, Name, Age, Gender, City, Original_Id, Original_Name, Original_Age, Original_Gender, Original_City);
        }
    }
